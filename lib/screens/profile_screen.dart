      ...
      body: Column(
        children: [
          ...
          const Text(
            'Cairo, Egypt',
            style: TextStyle(
                fontSize: 25, fontWeight: FontWeight.bold, color: Colors.black45),
          ),
          Container(
            height: 50,
            width: 150,
          ...
          const Row(
            ...
            children: [
              MyCircleAvatar(
                  imagePath: 'assets/images/IMG20200925094143.jpg', radius: 25),
              SizedBox(width: 10),
              MyCircleAvatar(
                  imagePath: 'assets/images/IMG20200925102033.jpg', radius: 25),
              SizedBox(width: 10),
              MyCircleAvatar(
                  imagePath: 'assets/images/IMG20200925101526.jpg', radius: 25),
              SizedBox(width: 10),
              MyCircleAvatar(
                  imagePath: 'assets/images/IMG20200926132552.jpg', radius: 25),
              SizedBox(width: 10),
            ],
          ),
          const SizedBox(height: 10),
          Container(
            ...
            child: const Row(
              ...
              children: [
                CustomColumn(number: '2.5K', title: 'connections'),
                VerticalDivider(color: Colors.white30),
                CustomColumn(number: '300', title: 'Endorsements'),
                VerticalDivider(color: Colors.white30),
                CustomColumn(number: '20', title: 'Recommends'),
                VerticalDivider(color: Colors.white30),
                CustomColumn(number: '15', title: 'post'),
              ],
            ),
          ),
        ],
